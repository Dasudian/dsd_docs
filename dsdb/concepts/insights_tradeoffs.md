...
The database must be able to handle a *high* volume of reads and writes.
  ...
  * *Con:* The DSDB development team was forced to make tradeoffs to increase performance
...
a new host that gets started and reports for a while and then gets shut down.
  * *Pro:* DSDB is good at managing discontinuous data
...
1. No one point is too important.
  * *Pro:* DSDB has very powerful tools to deal with aggregate data and large data sets
